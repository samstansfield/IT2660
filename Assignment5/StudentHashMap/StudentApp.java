...
public class StudentApp
{
    ...
    public static void main(String[] args)
    {
         ...
         while(!done)
         {
            ...
            System.out.println();
            System.out.println(" 5 to output the list");
            System.out.println();
            ...
            switch (tester.choice)
            {
                ...
                break;
                case 2:
                System.out.println("Please input a Student Number to search for");
                ...
                break;
                case 3:
                System.out.println("Please input a Student Number to delete");
                ...
                break;
                case 4:
                System.out.println("Input a Student Number of a record to update");
                tester.choice2 = keyboard.next();
                String oldStudent = tester.choice2;
                newStudent = new Student();
                newStudent.input();
                
                tester.structure.update(oldStudent,newStudent);
                break;
